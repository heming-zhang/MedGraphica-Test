...
class GATDecoder(nn.Module):
    def __init__(self, kg_emb_dim, input_dim, hidden_dim, embedding_dim, node_num, num_head, device, num_class):
        ...
        self.first_cross_modality = nn.Linear(kg_emb_dim+input_dim, input_dim)
    ...
    def forward(self, x, batch_entity_embeddings_tensor, batch_relation_embeddings_tensor, edge_index):
        # import pdb; pdb.set_trace()
        ...
        ### GAT layers
        x = self.conv_first(x_embed, edge_index)
